  ...
  tutorialsGrid.innerHTML = tutorials.map((tutorial) => `
    <div class="project-card" data-id="${tutorial.id}">
      <div class="project-image">
        <img src="${tutorial.image}" alt="${tutorial.title}" width="400" height="300" loading="lazy" onerror="this.src='/src/assets/images/Robo_Nexus_Logo.webp'">
...
function openModal(id) {
  ...
  modalBody.innerHTML = `
    <div class="modal-image">
      <img src="${tutorial.image}" alt="${tutorial.title}" width="600" height="400" loading="lazy" onerror="this.src='/src/assets/images/Robo_Nexus_Logo.webp'">
    </div>
